...
const Politics: React.FC = () => {
  ...
  const loadMoreArticles = async () => {
    setLoadingMore(true);
    const moreArticles = await optimizedNewsService.getNewsByCategory('politics', 4);
  ...
  useEffect(() => {
    const loadAllNews = async () => {
      ...
      try {
        console.log('🏛️ Fetching STRICTLY POLITICS NEWS with smart caching...');
        const articles = await optimizedNewsService.getNewsByCategory('politics', 50);
    ...
    return (
      <div className="home">
        <div className="home__container" style={{ textAlign: 'center', padding: '50px' }}>
          <h2 style={{ marginBottom: '30px' }}>Loading Politics News...</h2>
