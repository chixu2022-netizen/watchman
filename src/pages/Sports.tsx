...
interface NewsData {
  ...
  sportsUpdates: NewsArticle[];
  football: NewsArticle[];
  basketball: NewsArticle[];
  baseball: NewsArticle[];
  soccer: NewsArticle[];
  // Duplicate sections
  worldNews2: NewsArticle[];
  sportsUpdates2: NewsArticle[];
  football2: NewsArticle[];
  basketball2: NewsArticle[];
  baseball2: NewsArticle[];
  soccer2: NewsArticle[];
  worldNews3: NewsArticle[];
  sportsUpdates3: NewsArticle[];
  football3: NewsArticle[];
  basketball3: NewsArticle[];
  baseball3: NewsArticle[];
  soccer3: NewsArticle[];
}
...
const Sports: React.FC = () => {
  ...
  const loadMoreArticles = async () => {
    ...
    setTimeout(() => {
      const newSection = [
        mockArticle('Breaking: Championship finals set for this weekend'),
        mockArticle('Record-breaking performance shakes sports world'),
        mockArticle('Major trade deal announced in professional league'),
        mockArticle('Olympic preparations intensify as games approach')
      ];
      ...
      setTimeout(() => {
        setNewsData({
          ...
          football: [
            ...
            mockArticle('Emerging football show resilience despite global uncertainties', '/ttttttt.jpg')
          ],
          basketball: [
          ...
          football2: [
            ...
            mockArticle('Real estate football show strong fundamentals in urban areas', '/wm01.jpeg')
          ],
          basketball2: [
          ...
          football3: [
            mockArticle('Currency football adapt to changing monetary policy landscapes', '/wm01.jpeg'),
