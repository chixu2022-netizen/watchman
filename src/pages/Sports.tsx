...
const Sports: React.FC = () => {
  ...
  const loadMoreArticles = async () => {
    setLoadingMore(true);
    const moreArticles = await optimizedNewsService.getNewsByCategory('sports', 4);
  ...
  useEffect(() => {
    const loadAllNews = async () => {
      ...
      try {
        ...
        const articles = await optimizedNewsService.getNewsByCategory('sports', 50);
    ...
    return (
      <div className="home">
        <div className="home__container" style={{ textAlign: 'center', padding: '50px' }}>
          <h2 style={{ marginBottom: '30px' }}>Loading Sports News...</h2>
