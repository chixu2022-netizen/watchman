...
interface NewsData {
  ...
  localUpdates2: NewsArticle[];
  community2: NewsArticle[];
  government2: NewsArticle[];
  education2: NewsArticle[];
  events2: NewsArticle[];
  worldNews3: NewsArticle[];
  localUpdates3: NewsArticle[];
  community3: NewsArticle[];
  government3: NewsArticle[];
  education3: NewsArticle[];
  events3: NewsArticle[];
}
...
const Local: React.FC = () => {
  ...
  const loadMoreArticles = async () => {
    ...
    setTimeout(() => {
      const newSection = [
        mockArticle('Breaking: Local community center opens new facility'),
        mockArticle('City council approves major infrastructure project'),
        mockArticle('Local business wins national recognition award'),
        mockArticle('School district announces educational reforms')
      ];
      ...
      setTimeout(() => {
        setNewsData({
          ...
          community: [
            ...
            mockArticle('Emerging community show resilience despite global uncertainties', '/ttttttt.jpg')
          ],
          government: [
          ...
          community2: [
            ...
            mockArticle('Real estate community show strong fundamentals in urban areas', '/wm01.jpeg')
          ],
          government2: [
          ...
          community3: [
            mockArticle('Currency community adapt to changing monetary policy landscapes', '/wm01.jpeg'),
      ...
      <div className="home__container">
        ...
        <section id="business-section" className="crypto-section">          
          <div id="business-cards-container" className="crypto-cards">            
            {newsData.localUpdates.map((article, index) => (
        ...
        <section id="categories-section" className="categories-section">
          <div className="categories-grid">
            {/* Markets Column */}
            <div id="community-column" className="category-column">
              <h2 id="community-header" className="category-header">
                <a href="/community" className="category-link">Markets</a>
                <span className="arrow-symbol">›</span>
              </h2>
              
              {newsData.community.map((article: NewsArticle, index: number) => (
                <article key={index} id={`community-card-${index + 1}`} className={`category-card ${index === 0 ? 'featured' : ''}`}>
                  {index === 0 && (
            ...
            {/* Finance Column */}
            <div id="government-column" className="category-column">
              <h2 id="government-header" className="category-header">
                <a href="/government" className="category-link">Finance</a>
                <span className="arrow-symbol">›</span>
              </h2>
              
              {newsData.government.map((article: NewsArticle, index: number) => (
                <article 
                  key={index} 
                  id={`government-card-${index + 1}`} 
            ...
            {/* Startups Column */}
            <div id="education-column" className="category-column">
              <h2 id="education-header" className="category-header">
                <a href="/education" className="category-link">Startups</a>
                <span className="arrow-symbol">›</span>
              </h2>
              
              {newsData.education.map((article: NewsArticle, index: number) => (
                <article 
                  key={index} 
                  id={`education-card-${index + 1}`} 
                  className={`category-card ${index === 0 ? 'featured' : ''}`}
                >
                  {index === 0 && (
                    <div className="category-card-image">
            ...
            {/* Economy Column */}
            <div id="events-column" className="category-column">
              <h2 id="events-header" className="category-header">
                <a href="/events" className="category-link">Economy</a>
                <span className="arrow-symbol">›</span>
              </h2>
              
              {newsData.events.map((article: NewsArticle, index: number) => (
                <article 
                  key={index} 
